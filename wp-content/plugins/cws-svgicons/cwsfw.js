...
/*
	jQuery('#cwsfw_save, #cwsfw_save-1').on('click', function(e) {
		...
		jQuery('#cwsfw_save.button, #cwsfw_save-1.button').html('<i class="far fa-save"></i> Saved');
		// check requirement fields
		...
		setTimeout(function(){ jQuery('#cwsfw_save.button, #cwsfw_save-1.button').html('<i class="far fa-save"></i> Save Changes');} , 2000)
